...
from camera.record_alert import RecordAndAlert
...
class ProcessFrame:
    ...
    def __build(self): 
        ...
        self.__record_and_alert = RecordAndAlert(self.__config)
        self.__streaming = Streaming(self.__config)
    ...
    def __process(self, item: FrameDTO = None) -> None:
        try:
            ...
            _r = StreamDTO(item.source, new_frame, self.__config.camera.cameraType, is_mov, image)
            self.__record_and_alert.put_nowait(_r)
